...
class ClientTableItemMenu extends React.Component {
  state = {
      editOpen: false,
      deleteOpen: false,
      detailOpen: false,
  ...
  render() {
    ...
    <ModalForm
        ...
        form={<ClientForm 
                ...
                initialValues={_.pick(model,
                  'firstname', 'lastname', 'email', 'condition')}/>}
    ...
    const deleteForm = deleteOpen ? (
      <Dialog open={deleteOpen} aria-labelledby="simple-dialog-title2">
        <DialogTitle id="simple-dialog-title2">Eliminar Cliente</DialogTitle>  
        <DialogContent>
            <DialogContentText id="alert-dialog-description2">
              ¿Estás seguro que querés borrar el cliente?
            </DialogContentText>
        </DialogContent> 
        <DialogActions>
      ...
      <div>
        ...
        <IconButton onClick={this.onDetail}>
          ...
          <Dialog open={detailOpen} onClose={this.onDetailClose} aria-labelledby="simple-dialog-title">
            <DialogTitle id="simple-dialog-title">Info Cliente</DialogTitle>   
            <DialogContent>
...
export default ClientTableItemMenu;
